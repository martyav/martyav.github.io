...
The main challenge here was figuring out how to add write-in options with as little Javascript as possible. Surveys that don't include write-ins for race and gender are a pet peeve of mine. This one also made use of a background of linear gradient stripes, a favorite trick of mine back when I was working on blogs and forum themes.
